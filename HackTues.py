...
def on_gas(client, userdata, message):
    global gas
...
def on_light(client, userdata, message):# currently not displayed, found it useless
    global light
    val = message.payload.decode("utf-8")
    val = float(val)
    val=4096-val
...
def on_dust(client, userdata, message):
    global dust
...
client.message_callback_add("room/gas", on_gas)
client.message_callback_add("room/light", on_light)
client.message_callback_add("room/dust", on_dust)
client.message_callback_add("room/temperature", on_temperature)
client.message_callback_add("room/humidity", on_humidity)
